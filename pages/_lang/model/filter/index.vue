<template>
  <div class="filter-render">
    <div class="filter-render__project-name">
      <div class="filter-render__project-name__inner"><span>{{$t('labels.project')}}:</span></div>
      <div class="filter-render__project-name__inner--red"><span>{{$t('addresses.m3_gelovani')}}</span></div>
    </div>
    ...
    <div class="filter-render__aside">
      ...
      <gradient-progress class="filter-render__aside__progress" :label="$t('labels.sold_flat_count')" :min="0" :max="350" :value="project.flats_quantity" />
      <gradient-progress class="filter-render__aside__progress" :label="$t('labels.building_progress')" :min="0" :max="100" :value="project.building_status" suffix="%" />
    </div>
