<template>
  <div>
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      viewBox="0 0 772 389" style="enable-background:new 0 0 772 389;" xml:space="preserve">
      <style type="text/css">
        .st1{fill:#F26529;}
      </style>
      <image style="overflow:visible;enable-background:new;" width="100%" height="100%" xlink:href="@/assets/renders/render-small-2.png">
      </image>
      <g class="st0">
        <polygon class="st1" points="185.6,134.7 187.8,78.5 414.7,21.5 414.7,78.1 403.3,81.6 405.9,94.3 207.1,145.7 204.1,130.7"
          :class="{active: chosenBlock === 1}"
          @click="handleClick(1)"
        />
        <polygon class="st1" points="341.8,139.5 367.7,132.5 369.5,137.8 394.9,131.2 399.3,144.8 420.8,138.2 470.4,329.5 442.8,336.5 
          ...
          @click="handleClick(2)"
        />
        <polygon class="st1" points="249.3,168 249.3,159.3 278.7,159.3 278.7,205.8 275.1,205.8 275.1,231.2 278.7,231.2 279.5,231.2 
